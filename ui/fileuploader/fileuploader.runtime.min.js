...
e&&n(h))}var d=this,e=(new Date).getTime()+"_"+Math.floor(1E3*Math.random()),k,m,l,g,q=TW.Runtime.convertLocalizableString("[[FileUploaderWidget.fileuploader.dragorclick]]","Drag your files here or click in this area");this.runtimeProperties=function(){return{supportsAutoResize:!0,needsDataLoadingAndError:!1}};this.renderHtml=function(){return'<div class="widget-content widget-fileuploader widget-fileuploader-'+e+'">  <div class="widget-fileuploader-div widget-fileuploader-div-'+e+'">    <span class="widget-fileuploader-span widget-fileuploader-span-'+
